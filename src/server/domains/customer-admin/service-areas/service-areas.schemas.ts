...
export const createServiceAreaSchema = z.object({
  ...
  tipScreenBackgroundColor: z.string().min(1).nullable().optional(),
  tipScreenTextColor: z.string().min(1).nullable().optional(),
  tipScreenButtonColor: z.string().min(1).nullable().optional(),
  tipScreenButtonTextColor: z.string().min(1).nullable().optional(),
  tipScreenLogoImageUrl: z.string().url().nullable().optional(),
